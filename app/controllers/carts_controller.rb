  ...
  def create
   @changed = []
    ...
    respond_with do |format|
     format.json do
      render :json => {:need_application => @carts.detect{|i| i.application_area_mandatory }, :app_list => @app_list.sort_by{|l| l.application_area_name }, :rendered => @rendered, :carts => @carts, :changes => @changed }
