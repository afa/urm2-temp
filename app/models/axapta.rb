class Axapta
 ...
 attr_accessor :method
  ...
  def self.sales_close_reason_list
   begin
    AxaptaRequest.sales_close_reason_list(:user_hash => User.current.try(:current_account).try(:axapta_hash))["reason_list"].map{|x| [x["close_reason_id"], x["close_reason_description"]] }
   rescue
    []
   end
  end
